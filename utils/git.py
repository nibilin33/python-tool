    ...
    def get_projects(self):
        ...
        for i in range(1, 3):
            ...
            for r3 in r2:
                ...
                print(last_active_time,date_from,r3['name'])
                days = date_from - datetime.datetime.strptime(
                        last_active_time, '%Y-%m-%dT%H:%M:%S')
...
if __name__ == '__main__':
    ...
    project_info = ProjectInfo()
    project_info.project_id = 1286
    project_info.name = 'mp-micro-plugins'
    project_info.project_desc = ''
    project_info.project_url = ''
    gitlab4.get_branches(1286,project_info)
